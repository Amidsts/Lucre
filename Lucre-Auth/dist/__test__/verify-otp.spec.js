...
it("should throw for non existing account", () => __awaiter(void 0, void 0, void 0, function* () {
    const res = yield (0, supertest_1.default)(app_1.default).post("/v1/auth/verify-otp").send({
...
it("should throw for invalid otp", () => __awaiter(void 0, void 0, void 0, function* () {
...
it("should verify otp", () => __awaiter(void 0, void 0, void 0, function* () {
    yield user_model_1.default.create(payload);
